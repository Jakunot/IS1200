...
main:
	...
	nop
	# call tick
	la	$a0,mytime ##load mytime to address a0
	jal	tick
	nop
...
tick:	lw	$t0,0($a0)	# get time  ## mytime loaded in address a0 goes to t0
	addiu	$t0,$t0,1	# increase
	andi	$t1,$t0,0xf	# check lowest digit ## checks lowest digit and stores it in t1
	sltiu	$t2,$t1,0xa	# if digit < a, okay  ## a = 1010 and store it in t2
	bnez	$t2,tiend
	nop
...
printhour:		#surprise assignment, print "HOUR" every hour
